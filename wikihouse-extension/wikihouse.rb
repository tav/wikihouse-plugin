...
module WikihouseExtension # Top Level Namespace
  ...
  # ------------------------------------------------------------------------------
  # Make This House
  # These methods are instance methods of the module 'WikihouseExtension'
  # ------------------------------------------------------------------------------
  ...
  extend self # This makes each instance method defined above callable via the module 
  # instead of needing to instatiate a class first. 
